...
function OrionLib:MakeNotification(NotificationConfig)
	task.spawn(function()
		...
		local NotificationFrame = SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(18, 18, 18), 0, 10), {
			...
			MakeElement("Stroke", Color3.fromRGB(40, 40, 40), 1.2),
...
function OrionLib:MakeWindow(WindowConfig)
	...
	local function ToggleUI()
		if not Minimized then
			...
			local ContentTween = TweenService:Create(WindowStuff, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			...
			TweenService:Create(WindowStuff, TweenInfo.new(0.5, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
				Size = UDim2.new(0, 150, 1, -50),
				Position = UDim2.new(0, 0, 0, 50)
			}):Play()
	...
	function TabFunction:MakeTab(TabConfig)
		...
		if Icons[TabConfig.Icon] ~= nil then
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddBind(BindConfig)
				...
				local BindBox = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 4), {
					...
					AddThemeObject(MakeElement("Stroke"), "Stroke"),
					AddThemeObject(SetProps(MakeElement("Label", tostring(BindConfig.Default.Name), 14), {
						Size = UDim2.new(1, 0, 1, 0),
						Font = Enum.Font.GothamBold,
						TextXAlignment = Enum.TextXAlignment.Center,
						Name = "Value"
				...
				function Bind:Set(Key)
					...
					BindBox.Value.Text = Bind.Value.Name or tostring(Bind.Value)
				end
